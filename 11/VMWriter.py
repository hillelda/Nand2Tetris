...
class VMWriter:
    ...
    def __init__(self, output_stream: typing.TextIO) -> None:
        ...
        self.dict = {"CONST": "constant ", "ARG": "argument ", "FIELD": "this ",
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        self.output.write("push " + self.dict.get(segment) + str(index) + "\n")
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        self.output.write("pop " + self.dict.get(segment) + str(index) + "\n")
    ...
    def write_arithmetic(self, command: str) -> None:
        ...
        """
        self.output.write(self.dict.get(command) + "\n")
