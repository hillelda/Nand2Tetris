...
class Parser:
    ...
    def command_type(self) -> str:
        ...
        """
        # Your code goes here!
        if len(self.input_lines[self.current_command_idx]) == 1:
            return "C_ARITHMETIC"
        first_word = self.input_lines[self.current_command_idx][0]
        if first_word == 'push':
            return "C_PUSH"
        elif first_word == "pop":
            return "C_POP"
    ...
    def arg1(self) -> str:
        ...
        if self.command_type() == "C_ARITHMETIC":
            return self.input_lines[self.current_command_idx][0]
        else:
    ...
    def arg2(self) -> int:
        ...
        """
        return int(self.input_lines[self.current_command_idx][2])
